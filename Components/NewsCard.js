...
const NewsCard = (props) => {
    ...
    return (
      <View style={{marginBottom:16}}>
        ...
        {data?.content?(
          <TouchableOpacity style={{backgroundColor:"#0081C9", paddingHorizontal:16, paddingVertical:12}} onPress={handelMakeVideo}>
              <Text style={{fontSize:14, color:"#fff", fontWeight:"700"}}>Get short Video</Text>
          </TouchableOpacity>
          ):<></> 
        }
        <TouchableOpacity style={{backgroundColor:"#0081C9", paddingHorizontal:16, paddingVertical:12, alignSelf:"center"}} onPress={handelRead}>
